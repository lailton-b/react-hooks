...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=01%3A%20useState%3A%20greeting&em=lailton_b%40hotmail.com).

"Everytime a setState is called our component will re-render. So although this is awesome and makes us able to update the component without reloading the page, it's important to keep in mind that the whole component is being re-rendered and if you are not careful you can end up with performance problems if you have a big form, per exemple."